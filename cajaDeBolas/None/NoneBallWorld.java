...
//        balls[4] = new Ball(550, 300, 25, -3, 0, Color.MAGENTA);
        ...
        for (int x = 0; x < MAX_BALLS; x++) {
            ...
            ballsArray.add(new Ball(50 + rand.nextInt(200), 50 + rand.nextInt(200),6*rand.nextInt(5)+5,  rand.nextInt(6), -114 + rand.nextInt(174),new Color(r, g, b)        ));
