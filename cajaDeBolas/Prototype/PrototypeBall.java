 ...
 */
public class PrototypeBall {
   public float x, y;           // Ball's center x and y (package access)
   public float speedX, speedY; // Ball's speed per step in x and y (package access)
   private  final Color DEFAULT_COLOR = Color.BLUE;
   public PrototypeAperiences Apariencia;
    ...
    */
   public PrototypeBall(float x, float y, float speed, float angleInDegree,
         PrototypeAperiences Apariencia) {
      this.x = x;
      this.y = y;
   ...
   public void intersect(ContainerBox box, float timeLimit) {
      ...
      CollisionPhysics.pointIntersectsRectangleOuter(
            this.x, this.y, this.speedX, this.speedY, this.Apariencia.radius,
    ...
    * @param timeLimit: upperbound of the time interval.
    */
   public void intersect(PrototypeBall another, float timeLimit) {
      ...
      CollisionPhysics.pointIntersectsMovingPoint(
            this.x, this.y, this.speedX, this.speedY, this.Apariencia.radius,
            another.x, another.y, another.speedX, another.speedY, another.Apariencia.radius,
   ...
   public void draw(Graphics g) {
      ...
      g.fillOval((int)(x - Apariencia.radius), (int)(y - Apariencia.radius), (int)(2 * Apariencia.radius),
            (int)(2 * Apariencia.radius));
   }
   ...
   public float getMass() {
      return Apariencia.radius * Apariencia.radius * Apariencia.radius / 1000f;
   }
   ...
   public String toString() {
      ...
      formatter.format("@(%3.0f,%3.0f) r=%3.0f V=(%3.0f,%3.0f) " +
            ...
            x, y, Apariencia.radius, speedX, speedY, getSpeed(), getMoveAngle(),
