...
public class FlyweightBall {
   ...
   public FlyweightBallAperiences Apariencia;
    ...
    */
   public FlyweightBall(float x, float y, float speed, float angleInDegree,
         FlyweightBallAperiences Apariencia) {
      this.x = x;
      this.y = y;
    ...
    * @param timeLimit: upperbound of the time interval.
    */
   public void intersect(FlyweightBall another, float timeLimit) {
